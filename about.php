					...
					<div class="welcome-grids row">
							<div class="col-lg-6 mb-lg-0 mb-5">
								<h3 class="hny-title">Hello Buddy..!
									<br>Welcome to Handler<span class="dot-1">.</span></h3>
								...
								<div class="read">
									<a href="about.php" class="read-more-btn btn">Read More</a>
								</div>	
							</div>
					...
					<div class="align-counter-6-inf-cols row">
						...
						<div class="counter-6-inf-right counter-6-inf-right2 col-lg-6">
								...
								<div class="calltoaction-text-info mt-lg-5 mt-4">
									...
									<div class="buttons">
											<a href="blog-single.php" class="read-more-btn btn">Read More</a>
											<a href="blog-single.php" class="read-more-btn2 btn">More Info</a>
										</div>
						</div>
					</div>
				 </div>
